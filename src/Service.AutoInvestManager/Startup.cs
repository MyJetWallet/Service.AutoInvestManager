...
using Service.AutoInvestManager.Modules;
using Service.AutoInvestManager.Postgres;
using Service.AutoInvestManager.Services;
using SimpleTrading.BaseMetrics;
using SimpleTrading.ServiceStatusReporterConnector;

namespace Service.AutoInvestManager
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {
                endpoints.MapGrpcSchema<AutoInvestService, IAutoInvestService>();
            });
        }
